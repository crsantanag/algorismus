                ...
                <div>
                    <div className="mx-3 bg-black text-white grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">  
                        ...
                        <Card className="max-w-[400px] bg-black text-white border-white border-2 rounded-2xl">
                            <p className="my-4 text-center font-bold text-2xl">HTML 5, CSS 3 y Bootstrapt</p>
                        ...
                        <Card className="max-w-[400px] bg-black text-white border-white border-2 rounded-2xl">
                        <p className="my-4 text-center font-bold text-2xl">JavaScript y React</p>
                        ...
                        <Card className="max-w-[400px] bg-black text-white border-white border-2 rounded-2xl">
                            <p className="my-4 text-center font-bold text-2xl">Bases de Datos</p>
                            <CardHeader className="flex gap-3  bg-black text-white">
                                <Image className="border-white border-2"
                                        alt="Curso_3"
                                        radius="sm"
                        ...
                        <Card className="max-w-[400px] bg-black text-white border-white border-2 rounded-2xl">
                            <p className="my-4 text-center font-bold text-2xl">Ruby on Rails</p>
                            <CardHeader className="flex gap-3  bg-black text-white">
                                <Image
                                    className="border-white border-2"
                                    alt="Curso_4"
                        ...
                        <Card className="max-w-[400px] bg-black text-white border-white border-2 rounded-2xl">
                            <p className="my-4 text-center font-bold text-2xl">Python y Django</p>
                            <CardHeader className="flex gap-3  bg-black text-white">
                                <Image
                                    className="border-white border-2"
                                    alt="Curso_5"
